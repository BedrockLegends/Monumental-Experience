...
//hopper
  event.add('forge:tools/hopper', ['minecraft:hopper', 'engineersdecor:factory_hopper', 'pneumaticcraft:liquid_hopper', 'pneumaticcraft:omnidirectional_hopper', 'naturesaura:grated_chute'])
